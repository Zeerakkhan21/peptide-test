...
module.exports = async function handler(req, res) {
  ...
  // browser's Origin host will match the request host. Comparing hosts rather
  // than full origins keeps preview URLs, production, future custom domains and
  // plain-http local development all working. Origin is set by the browser and
  // cannot be forged from one, and a non-browser client sends none at all, so
